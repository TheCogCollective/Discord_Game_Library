...
class Game(commands.Cog):
    ...
    async def suggest(self, ctx: commands.Context, choice: Optional[str] = None) -> None:
        """
        List out games common to all users in your voice channel, or all current online users
    ...
    async def poll(self, ctx: commands.Context, choice: Optional[str] = None) -> None:
        ...
        choice: Defaults to 'online'. Either 'online' (for all online users; honours 'dnd' status) or 'voice' (for all users in a voice channel))
        """
